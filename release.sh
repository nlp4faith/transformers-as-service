...
CLIENT_DIR='client/'
SERVER_DIR='server/'
CLIENT_CODE=$CLIENT_DIR'transformer_serving/client/__init__.py'
SERVER_CODE=$SERVER_DIR'transformer_serving/server/__init__.py'
